                    ...
                    context.embedTemplates.confirmation(
                        context.translate(
                            ...
                            mapOf(
                                ...
                                "message" to message.orEmpty() // Include the message in the confirmation embed
                            )
                        ),
                            ...
                            context.embedTemplates.normal(
                                context.translate(
                                    ...
                                    mapOf(
                                        ...
                                        "level" to pokemon.level.toString(),
                                        "pokemon" to context.translator.pokemonDisplayName(pokemon, false),
                                        "message" to message.orEmpty() // Include the message in the received gift embed
                                    )
                                ),
                        ...
                        context.embedTemplates.success(
                            context.translate(
                                ...
                                mapOf(
                                    ...
                                    "ivPercentage" to pokemon.ivPercentage,
                                    "pokemon" to context.translator.pokemonDisplayName(pokemon, false),
                                    "message" to message.orEmpty() // Include the message in the success embed
                                )
                            ),
